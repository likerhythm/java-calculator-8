...
public class BrainTest {
    ...
    void 매우_긴_소수의_계산을_오차_없이_정상적으로_수행합니다() {
        ...
        Assertions.assertEquals("246.2469135782469134", brain.plus(new PostFix(a + " " + b + " +", true)));
    }
    ...
    void 매우_큰_수의_계산을_정상적으로_수행합니다() {
        ...
        Assertions.assertEquals("200000000000000000000000000", brain.plus(new PostFix(a + " " + b + " +", true)));
    }
}
